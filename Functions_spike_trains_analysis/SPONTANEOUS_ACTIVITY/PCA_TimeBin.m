function [Lambda,Coefs,CosAngles]=PCA_TimeBin(filename,nJ,minRate,tW,MakePlot)
...
for i=1:nT
    ...
    [~,SpkMC,~]=SpkCountMat_Centered(filename,tW(i),nJ,minRate);
    ...
    [c,~,l]= princomp(SpkMCs); %        pca(SpkMCs);
