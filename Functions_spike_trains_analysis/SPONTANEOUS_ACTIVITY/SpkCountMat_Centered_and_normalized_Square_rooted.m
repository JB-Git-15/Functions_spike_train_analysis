function [SpkCountMat,SpkCountMatC,iLow,SpkCountMat_z,t_bin] = SpkCountMat_Centered_and_normalized_Square_rooted(filename,tWin,N_jitt,minRate)
...
% Square root the counts

   SpkCountMat   = sqrt(SpkCountMat);
