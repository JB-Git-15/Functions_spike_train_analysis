function [ccgs,tccg] = CCGsFromMat_V2(filename,Mat,bin,Nbin,SR,gsub,epochs,Normalization,MakePlot)
...
[ccgs,tccg]=CCG_Ken(rs,cl,bin,Nbin,SR,gsub, Normalization ,epochs);     % or CCG_Ken
