function [rslt,time] = Convolve_Mex_hat_w_Mat_v2(Mat,sdt_1,sdt_2,sdtmax,dt,tlim)

% Function that convolves (smooths) a cell array Mat containing a point process on each
% elemment with a Mexican hat kernel of parameters sdt_1 and sdt_2 sampled at resolution dt.
...
extended_impulse_response  = normpdf(time_centered_extended,0,sdt_1) - normpdf(time_centered_extended,0,sdt_2);
